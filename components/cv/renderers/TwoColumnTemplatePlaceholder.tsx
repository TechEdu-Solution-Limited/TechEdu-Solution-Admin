// components/renderers/TwoColumnTemplatePlaceholder.tsx
"use client";
import React from "react";
import { TemplateLayout } from "@/types/cv/template";
import { mapFontFamily } from "@/utils/cv/fontUtils";
import { SPACING, LAYOUT } from "@/utils/cv/templateConstants";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Two Column Layout — split background fills remaining page height */}
        <div
          className="flex flex-1" // <-- stretches to bottom of A4 page
          style={{
        ...
        >
          {/* Left Column Placeholder (transparent) */}
          <div
            className="p-8"
            style={{
              width: `${leftWidthPct}%`,
          ...
          {/* Right Column Placeholder (transparent) */}
          <div
            className="p-8"
            style={{
              width: `${rightWidthPct}%`,
